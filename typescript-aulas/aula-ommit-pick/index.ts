...
type LocalGithubUsers = Pick<GithubUserResponse, 'id' | 'login' | 'name' | 'bio'>
type LocalGithubRepo = Pick<GithubRepoResponse, 'name' | 'description' | 'fork'>

let localUser: LocalGithubUsers
