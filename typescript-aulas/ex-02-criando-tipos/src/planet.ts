type StatusPlanet = "Habitado" | "Habitável" | "Inabitável" | "Inexplorado"
type CordsPlanet = [number, number, number, number]
type Planet = {
    name: string,
    cords: CordsPlanet,
    status: StatusPlanet,
...
function addPlanet(name: string, cords: CordsPlanet, status: StatusPlanet) {
    planets.push({
        name,
        cords,
        status,
...
function updateStatus(status: StatusPlanet, planet: Planet) {
